fn main() {
    ...
    println!("The Maximum number in i8 = {}", i8::MAX);
    println!("The Maximum number in u8 = {}", u8::MAX);
    ...
    println!("The Maximum number in f32 = {}", f32::MAX);
    ...
    let not_equals = z != x; // you can use > < >= or <=
